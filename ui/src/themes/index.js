...
export default {
  ...
  LightTheme: NautilineTheme,
  DarkTheme: NautilineTheme,

  // New themes should be added here, in alphabetic order
  AmusicTheme: NautilineTheme,
  CatppuccinMacchiatoTheme: NautilineTheme,
  CatppuccinLatteTheme: NautilineTheme,
  DraculaTheme: NautilineTheme,
  ElectricPurpleTheme: NautilineTheme,
  ExtraDarkTheme: NautilineTheme,
  GreenTheme: NautilineTheme,
  GruvboxDarkTheme: NautilineTheme,
  LigeraTheme: NautilineTheme,
  MonokaiTheme: NautilineTheme,
  MoonbaseAlphaTheme: NautilineTheme,
  MoonbaseBravoTheme: NautilineTheme,
  NautilineTheme: NautilineTheme,
  NordTheme: NautilineTheme,
  NuclearTheme: NautilineTheme,
  NutballTheme: NautilineTheme,
  SpotifyTheme: NautilineTheme,
  SquiddiesGlassTheme: NautilineTheme,
  TokyoNightLightTheme: NautilineTheme,
  TokyoNightTheme: NautilineTheme,
}
